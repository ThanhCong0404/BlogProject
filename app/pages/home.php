    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        <a href="/" class="d-flex align-items-center mb-2 mb-lg-0 text-dark text-decoration-none">
          ...
          <img class="bi me-2" src="<?php echo ROOT?>/assets/images/logo.jpg" width="60" height="52" style="object-fit: cover;"  />
        </a>
    ...
    <div class="row my-2">
      <div class="col-md-6">
        <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
          ...
          <div class="col-lg-5 col-12 d-lg-block">
            ...
            <img src="<?php echo ROOT?>/assets/images/3.jpg" class="bd-placeholder-img w-100" style="object-fit: cover;" width="200" height="250">
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6">
        <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
          ...
          <div class="col-lg-5 col-12 d-lg-block">
            <img src="<?php echo ROOT?>/assets/images/4.jpg" class="bd-placeholder-img w-100" style="object-fit: cover;" width="200" height="250">
